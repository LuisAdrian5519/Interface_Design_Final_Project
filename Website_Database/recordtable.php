    ...
    <table class="styled-table" id= "table_id">
      <thead>
        <tr>
          ...
          <th>ID</th>
          <th>BOARD</th>
          <th>PESO DE RESIDUO ORGANICO (kg.)</th>
          <th>PESO DE RSU PER CAPITA (kg.)</th>
          <th>ESTADO DE SENSORES</th>
          <th>BOTE ID</th>
      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          $sql = 'SELECT * FROM esp32_table_registropesos ORDER BY fecha DESC';
          foreach ($pdo->query($sql) as $row) {
            $fecha = date_create(datetime: $row['fecha']);
            ...
            echo '<td class="bdr">'. $row['Peso_de_Residuo_Organico'] . '</td>';
            echo '<td class="bdr">'. $row['Peso_de_Residuo_Inorganico'] . '</td>';
            echo '<td class="bdr">'. $row['Estado_Sensores'] . '</td>';
            echo '<td class="bdr">'. $row['Bote_ID'] . '</td>';
